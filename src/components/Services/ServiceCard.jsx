...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    ...
    >
      ...
      <div className="h-full! flex! flex-col! bg-white/80 dark:bg-dark-500 backdrop-blur-sm! rounded-2xl! shadow-xl! hover:shadow-2xl! transition-all! duration-500! border! border-gray-200/80! dark:border-gray-700/80! overflow-hidden!">
