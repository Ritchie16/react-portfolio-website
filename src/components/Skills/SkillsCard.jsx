...
const SkillsCard = ({ skillCategory, index }) => {
  return (
    <Motion.div
      ...
      className="h-full"
    >
      <div className="h-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6! shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700/50 hover:border-primary-300 dark:hover:border-primary-500 overflow-hidden group">
        {/* Category Header */}
